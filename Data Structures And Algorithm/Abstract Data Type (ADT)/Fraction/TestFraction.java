...
public class TestFraction 
{
	public static void main(String[] args) 
    {
		...
		int a = sc.nextInt();
		int b = sc.nextInt();
		FractionI f1 = new Fraction(a, b);  // da hinh qua interface. Dau co tao doi tuong cua Interface dau

		System.out.print("Enter 2nd fraction: ");
		a = sc.nextInt();
		b = sc.nextInt();
		FractionI f2 = new Fraction(a, b);  // da hinh qua interface. Dau co tao doi tuong cua Interface dau
